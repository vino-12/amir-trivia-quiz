...
(901, 'sports', 'Which was the first football team to win back to back Super Bowls with different coaches?', 'San Francisco', 'Baltimore', 'Dallas', 'Miami', '', 'answer-1'),
(902, 'sports', 'How many points did Wilt Chamberlain score in his best game versus New York?', '99', '100', '86', '105', '', 'answer-2'),
(903, 'sports', 'Who is the youngest NBA player to score 10,000 points.', 'Michael Jordan', 'Kobe Bryant', 'Lebron James', 'Kevin Durant', '', 'answer-3'),
(904, 'sports', 'He is the shortest player ever to win the Slam Dunk Contest.', 'Nate Robinson', 'Spud Webb', 'Tyronne Bogues', 'Chris Paul', '', 'answer-2'),
(905, 'sports', 'Who is the first player to top 20,000 points in NBA?', 'Michael Jordan', 'Wilt Chamberlain', 'Larry Bird', 'Bob Pettit', '', 'answer-4'),
(906, 'sports', 'He retired with the NBAs highest scoring average (30.1 points per game).', 'Kobe Bryant', 'Magic Johnson', 'Shaquille O\'neal', 'Michael Jordan', '', 'answer-4'),
(907, 'sports', 'He is the NBAs All-Time scorer.', 'Lebron James', 'Kareem Abdul-Jabbar', 'Michael Jordan', 'Kobe Bryant', '', 'answer-1'),
(908, 'sports', 'He was a player, coach, and owner  -all for one team. He was also instrumental in developing the NFL. \r\n', 'George Halas', 'Wellington Mara', 'Red Grange', 'Pete Rozelle', '', 'answer-1'),
(909, 'sports', 'This college and pro great had a very strange nickname -Crazy Legs.   His last name was Hirsch.  What was his real first name ?\r\n', 'Lester', 'Arnie', 'Elroy', 'Cliff', '', 'answer-3'),
